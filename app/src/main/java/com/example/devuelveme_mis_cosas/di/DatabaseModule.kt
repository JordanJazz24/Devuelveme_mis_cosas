...
import com.example.devuelveme_mis_cosas.data.repository.LoanPaymentRepositoryImpl
...
object DatabaseModule {
    ...
    fun provideLoanDatabase(@ApplicationContext context: Context): LoanDatabase {
        ...
        .addMigrations(
            LoanDatabase.MIGRATION_1_2, 
            LoanDatabase.MIGRATION_2_3,
            LoanDatabase.MIGRATION_3_4
        )
        .build()
    }
    ...
    @Provides
    fun provideLoanPaymentDao(database: LoanDatabase): LoanPaymentDao {
    ...
    @Provides
    @Singleton
    fun provideLoanPaymentRepository(dao: LoanPaymentDao): LoanPaymentRepository {
        return LoanPaymentRepositoryImpl(dao)
    }
